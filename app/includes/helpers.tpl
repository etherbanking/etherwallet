<div class="" ng-controller="helpersCtrl">
  ...
  <div class="form-group">
    <ul>
      ...
      <li><a href="https://MyEbcWallet.groovehq.com/knowledge_base/topics/how-do-i-create-a-new-wallet" target="_blank" rel="noopener">Read this guide for more information.</a></li>
      <li><a href="https://MyEbcWallet.groovehq.com/knowledge_base/topics/protecting-yourself-and-your-funds?from_search=true" target="_blank" rel="noopener">Learn how to protect yourself and your funds.</a></li>
    </ul>
  </div>

...
globalFuncs.errorMsgs = [
    ...
    'Input address is not checksummed. <a href="https://MyEbcWallet.groovehq.com/knowledge_base/topics/not-checksummed-shows-when-i-enter-an-address" target="_blank" rel="noopener"> More info</a>', // 35
...
globalFuncs.checkAndRedirectHTTPS = function() {
    var host = "myebcwallet.com";
    var hostw = "https://www.myebcwallet.com";

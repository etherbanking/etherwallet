...
HELP_16_Desc_1              : 'Bạn có thể sử dụng Blockchain Explorer dễ kiễm tra, Ví dụ: [scan.ebccoin.io](http://scan.ebccoin.io/). Dán địa chỉ của bạn vào khung tìm kiếm và nó sẽ hiển thị tài khoản của bạn và toạn bộ lịch sữ giao dịch đã thực hiện đối với địa chỉ này. Ví Dụ: Đây là địa chỉ của chúng tôi [donation account](http://scan.ebccoin.io/account/0x7cb57b5a97eabe94205c07890be4c1ad31e486a8) được trông thấy trên scan.ebccoin.io ',

...
tx_Summary                  : 'Ten tijden van hoog transactie volume (zoals tijdens ICOs) kunnen transacties voor uren, zo niet niet dagen, "pending" blijven. Deze tool heeft als doel om je de mogelijkheid te geven om deze TXs op te sporen en ze te "annuleren" / vervangen. ** Dit is niet typisch iets wat je kunt doen. Je zou er niet op moeten vertrouwen dat dit werkt & het kan alleen werken als de TX Pools vol zitten. [Lees hier meer over deze tool.](https://MyEbcWallet.groovehq.com/knowledge_base/topics/how-can-i-check-on-the-status-of-my-transaction-can-i-cancel-override-overwrite-replace-or-do-anything-once-a-transaction-has-been-sent)**',
...
tx_notFound_4               : 'Gebruik het drop-down menu in de rechterbovenhoek & selecteer een andere ETH node (bijvoobeeld `ETH (scan.ebccoin.io)` of `ETH (Infura.io)` of `ETH (MyEbcWallet)`) en check opnieuw.',
...
tx_FoundOnChain_3           : '**Als je geen enkele foutmelding ziet is je transactie met succes verzonden.** Je ETH of Tokens zijn waar je ze naar verzonden hebt. Als je je verzonden ETH of Tokens niet gecrediteerd ziet in je andere wallet / exchange account, en het is inmiddels al 24+ uur geleden sinds je de transactie verzonden hebt, neem dan [contact op met die service](https://MyEbcWallet.groovehq.com/knowledge_base/topics/i-have-a-question-but-its-not-about-MyEbcWallet-dot-com-what-do-i-do). Geef ze de *link* naar je transactie en vraag ze op je allerliefste manier om naar je situatie te kijken.',
...
GEN_Help_12                 : 'Gebruik het enkel om je wallet te openen via MyEbcWallet (of Mist, Geth, Parity en andere wallet clients.) ',
...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GWEI -> ETH converteren](https://www.myebcwallet.com/helpers.html)',
...
ADD_Ledger_0a               : 'Her-open MyEbcWallet met een veilige (SSL) verbinding ',
ADD_Ledger_0b               : 'Her-open MyEbcWallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Als je deze wallet in de toekomst nog wilt gebruiken met MyEbcWallet CX, zul je het met de hand moeten toevoegen door gebruik te maken van de prive sleutel/JSON en wachtwoord. ',
...
NODE_Warning                : 'Je node dient HTTPS te zijn om met myebcwallet.com te kunnen verbinden. Je kunt de [MyEbcWallet repo downloaden](https://github.com/kvhnuke/etherwallet/releases/latest) en lokaal uitvoeren en vervolgens met iedere node verbinden. Of, verkrijg een gratis SSL certificaat via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Naam',
...
ERROR_28                    : '**Je hebt je Keystore Bestand & wachtwoord of prive sleutel nodig** om toegang tot deze wallet te verkrijgen in de toekomst. Sla het op & maak een externe back-up! Er is geen enkele manier om je wallet te herstellen als je het nu niet opslaat. Lees ook de help pagina (https://www.myebcwallet.com/#help) voor instructies. ',
...
ERROR_35                    : 'Input adres is niet ge-checksummed. <a href="https://MyEbcWallet.groovehq.com/knowledge_base/topics/not-checksummed-shows-when-i-enter-an-address" target="_blank" rel="noopener"> Meer info</a>', // 35
...
TranslatorName_1            : '[h3ll0fr13nd](https://www.myebcwallet.com/?gaslimit=21000&to=0xB5FbCE123F12347206c881cae73A3046BA1A90bA&value=1.0#send-transaction) ',
...
HELP_2b_Title               : '2b) Hoe doe ik veilig / offline / cold storage met MyEbcWallet? ',
...
HELP_3_Desc_3               : 'Navigeer naar de myebcwallet.com "Bekijk Wallet Info" pagina. ',
...
HELP_4CX_Title              : '4) Hoe verzend ik Ether met MyEbcWallet CX? ',
...
HELP_5_Title                : '5) Hoe voer ik myebcwallet.com offline/lokaal uit? ',
HELP_5_Desc_1               : 'Je kunt myebcwallet.com uitvoeren op je eigen computer in plaats van op de GitHub servers. Je kunt een wallet volledig offline genereren en transacties versturen met behulp van de "Offline Transactie" pagina. ',
HELP_5_Desc_7               : 'myebcwallet.com draait nu volledig op jouw computer. ',
HELP_5_Desc_8               : 'Voor het geval dat je er niet bekend mee bent: je hebt de volledige map nodig om de site lokaal te draaien, niet alleen het `index.html` bestand. Laat alle bestanden in de map met rust en ga ze niet verplaatsen. Als je een back-up wilt bewaren van de MyEbcWallet repo voor de toekomst, raden we je aan om alleen de ZIP te bewaren zodat je zeker weet dat de inhoud intact blijft. ',
HELP_5_Desc_9               : 'Gezien we myebcwallet.com continu updaten, raden we je aan om regelmatig je opgeslagen versie van de repo bij te werken. ',
...
HELP_8_Desc_1               : 'MyEbcWallet is geen web wallet. Je hoeft niet in te loggen en er zal nooit iets van je op onze servers worden bewaard. Onze website is enkel een interface om toegang te verkrijgen tot de blockchain. ',
HELP_8_Desc_2               : 'Als myebcwallet.com er mee stopt, zul je een andere manier moeten zien te vinden (zoals geth of Ethereum Wallet / Mist) om te doen wat wij doen. Maar wat je niet zult hoeven te doen is je Ether uit MyEbcWallet halen omdat het niet in MyEbcWallet zit. Je Ether zit in in welk wallet dan ook je op onze site hebt gegenereerd. ',
...
HELP_12_Title               : '12) Hoe importeer ik een MyEbcWallet  wallet in geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Door gebruik te maken van een Geth/Mist JSON bestand van MyEbcWallet v2+.... ',
...
HELP_14_Title               : '14) Sommige sites zorgen voor een willekeurigheid (seed) bij het genereren van de prive sleutel via muis bewegingen. myebcwallet.com doet dit niet. Is de wikkeleurigheid (random number generation) van MyEbcWallet wel veilig? ',
HELP_14_Desc_1              : 'Hoewel het bewegen van de muis een slimme truck is en we begrijpen waarom mensen dit een goed idee vinden, is de werkelijkheid dat "window.crypto" een grotere willekeurigheid (hogere entropie) zeker stelt dan je muisbewegingen. De muisbewegingen zijn niet onveilig, echter wij (en enorm veel andere crypto experimenten) geloven in "window.crypto". Bovendien kan myebcwallet.com gebruikt worden op touchscreen apparaten. Hier vind je een [conversatie tussen een boze redditor en Vitalik Buterin over de muisbewegingen v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_16_Desc_1              : 'Je kunt hiervoor een blockchain explorer gebruiken zoals bijvoorbeeld [scan.ebccoin.io](http://scan.ebccoin.io/). Plak daar je adres in de zoekbalk en je adres en transactie geschiedenis zullen worden getoond. Bekijk bijvoobeeld hoe ons [donatie account](http://scan.ebccoin.io/account/0x7cb57b5a97eabe94205c07890be4c1ad31e486a8)  eruit ziet op scan.ebccoin.io ',
...
HELP_SecCX_Title            : 'Beveiliging - MyEbcWallet CX ',
...
HELP_SecCX_Desc_6           : 'Als we deze items zouden versleutelen, zou je iedere keer dat je je saldo of nicknames wilt checken je wachtwoord moeten invoeren. Als je je hierover zorgen maakt, raden we je aan om gebruik te maken van myebcwallet.com in plaats van deze Chrome Extensie. ',
...
HELP_Sec_Desc_2             : 'We zijn up en running sinds augustus 2015. Als je zoekt naar ["MyEbcWallet" on reddit](https://www.reddit.com/search?q=MyEbcWallet), zul je tal van mensen vinden die ons met groot succes gebruiken. ',
...
HELP_Sec_Desc_4             : 'Controleer de URL -- Deze website draait vanaf GitHub en je kunt de bron code hier vinden: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) naar de domein namen: [https://www.myebcwallet.com](https://www.myebcwallet.com). ',

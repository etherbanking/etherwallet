...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélecctionner un node ETH différent (par ex. `ETH (scan.ebccoin.io)` ou `ETH (Infura.io)` ou `ETH (MyEtherWallet)`) et revérifiez.',
...
HELP_14_Title               : '14) Certains sites randomisent (initialisent) la génération de clef privée par les mouvements de la sours. Ce n\'est pas le cas de myebcwallet.com. La génération de nombres aléatoires de MyEtherWallet est-elle sûre ? ',

...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélecctionner un node ETH différent (par ex. `ETH (scan.ebccoin.io)` ou `ETH (Infura.io)` ou `ETH (MyEbcWallet)`) et revérifiez.',
...
tx_FoundOnChain_3           : '**Si vous ne voyez pas d\'erreur, votre transaction a été envoyée avec succès.** Vos ETH ou Tokens sont à l\'endroit où vous les avez envoyés. Si vous ne voyez pas ces ETH ou Tokens dans votre autre portefeuille ou compte de place d\'échange, et si cela fait plus de 24 heures, veuillez [contacter ce service](https://MyEbcWallet.groovehq.com/knowledge_base/topics/i-have-a-question-but-its-not-about-MyEbcWallet-dot-com-what-do-i-do). Envoyez-leur le *lien* vers votre transaction et demandez, poliment, d\'examiner votre situation.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec MyEbcWallet (ou Mist, Geth, Parity et autres wallet clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `gas limit` * le `gas price`. [Vous pouvez convertir GWEI -> ETH ici](https://www.myebcwallet.com/helpers.html)',
...
MYWAL_Content_3             : 'Si vous voulez utiliser ce portefeuille avec MyEbcWallet CX à l\'avenir, vous devrez le rajouter manuellement en utilisant la clé privée/fichier JSON et le mot de passe. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Ceci vous permet de télécharger plusieurs versions des clefs privées et de ré-imprimer votre portefeuille papier. Vous devrez le faire pour [importer votre compte dans Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vous voulez consulter votre solde, nous recommandons d\'utiliser un explorateur de blockchain comme [scan.ebccoin.io](http://scan.ebccoin.io/). ',
...
ADD_Ledger_0a               : 'Réouvrir MyEbcWallet sur une connexion sécurisée (SSL) ',
ADD_Ledger_0b               : 'Réouvrir MyEbcWallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
x_Trezor                    : 'TREZOR ',
...
NODE_Warning                : 'Votre nœud doit être en HTTPS pour vous y connecter via myebcwallet.com. Vous pouvez [téléccharger le repo MyEbcWallet et le lancer localement](https://github.com/kvhnuke/etherwallet/releases/latest) pour vous connecter à un nœud quelconque, ou obtenir un certificat SSL gratuit via [LetsEncrypt](https://letsencrypt.org/)',
...
TranslatorName_1            : '[Simon P](https://www.myebcwallet.com/?gaslimit=21000&to=0x89a18eE46b5aabC62e94b1830881887D04C687f3&value=1.0#send-transaction) · ',
...
HELP_Desc                   : 'Il manque quelque chose ? Vous avez d\'autres questions ? [Contactez-nous](mailto:support@myebcwallet.com), et non seulement nous allons vous répondre mais aussi mettre à jour cette page afin qu\'elle soit plus utile à tout le monde à l\'avenir ! ',
HELP_Remind_Title           : 'Quelques rappels : ',
HELP_Remind_Desc_1          : '**Ethereum, myebcwallet.com & MyEbcWallet CX, et certaines des bibliothèques Javascript sous-jacentes que nous employons sont en cours de développement.** Bien que nous les ayons testés intensivement et que des dizaines de milliez de portefeuilles aient été créés avec succès dans le monde entier, il existe toujours une faible possibilité qu\'un incident se produise conduisant à la perte de vos ETH. N\'investissez pas plus que ce que vous êtes prêt à perdre et soyez prudent. En cas d\'accident, nous en serons désolés mais **nous ne sommes pas responsables d\'une éventuelle perte de cet Ether**. ',
HELP_Remind_Desc_2          : 'myebcwallet.com & MyEbcWallet CX ne sont pas des "portefeuilles web". Vous ne créez pas un compte, vous ne nous donnez pas votre Ether en dépôt. Aucune donnée ne sort de votre ordinateur ou votre navigateur. Nous vous facilitons la création, la sauvegarde et l\'accès à vos informations ainsi que l\'interaction avec la blockchain. ',
...
HELP_0_Desc_1               : 'MyEbcWallet vous donne la possibilité de générer de nouveaux portefeuilles pour stocker votre Ether par vous-même et pas sur un *exchange.* Ce processus ne s\'exécute que sur votre ordinateur, pas sur nos serveurs. Quand vous générez un nouveau portefeuille, **il est donc de votre responsabilité de le sauvegarder de manière sécurisée.** ',
...
HELP_2b_Title               : '2b) Comment puis-je gérer en toute sécurité un stockage hors ligne avec MyEbcWallet? ',
...
HELP_3_Desc_3               : 'Naviguez vers la page Visualisation d\'un portefeuille" de myebcwallet.com. ',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'Ether avec MyEbcWallet CX ? ',
...
HELP_5_Title                : '5) Comment puis-je lancer myebcwallet.com hors ligne/localement ? ',
HELP_5_Desc_1               : 'Vous pouvez lancer myebcwallet.com sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne". ',
HELP_5_Desc_7               : 'myebcwallet.com tourne maintenant complètement sur votre ordinateur. ',
HELP_5_Desc_8               : 'Au cas où cela ne vous soit pas familier, vous devez conserver l\'intégralité du dossier pour faire tourner le site web et non uniquement `index.html`. Ne touchez à rien, ne déplacez rien dans le dossier. Si vous stockez une sauvegarde du repo MyEbcWallet pour l\'avenir, nous vous recommandons ne ne stocker que le ZIP afin d\'être sûr que le contenu du dossier restera intact. ',
HELP_5_Desc_9               : 'Comme nous améliorons constamment myebcwallet.com, nous vous recommandons de mettre régulièrement à jour votre version sauvegardée. ',
...
HELP_8_Desc_1               : 'MyEbcWallet n\'est pas un portefeuille sur le web. Vous n\'avez pas de login et rien n\'est jamais stocké sur nos serveurs. Ce n\'est qu\'une interface qui vous permet d\'interagir avec la blockchain. ',
HELP_8_Desc_2               : 'Si myebcwallet.com tombe, vous devrez trouver un autre moyen (comme geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre Ether depuis MyEbcWallet parce qu\'il ne se trouve pas dans MyEbcWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site. ',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par MyEbcWallet CX. De cette manière, si quoi que ce soit arrivait à MyEbcWallet CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre Ether. Voir #2a pour la sauvegarde de vos portefeuilles. ',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, MyEbcWallet CX disparaissait du Chrome Store, vous pourrez en trouver le source sur Github et le charger manuellement. Voir #5 ci-dessus. ',
...
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par MyEbcWallet dans geth / Ethereum Wallet / Mist ? ',
HELP_12_Desc_1              : 'Avec un fichier Geth/Mist JSON de MyEbcWallet v2+.... ',
...
HELP_14_Title               : '14) Certains sites randomisent (initialisent) la génération de clef privée par les mouvements de la sours. Ce n\'est pas le cas de myebcwallet.com. La génération de nombres aléatoires de MyEbcWallet est-elle sûre ? ',
HELP_14_Desc_1              : 'Bien que l\'interception des mouvement de la souris soit jugée attractive par beaucoup, et que nous en comprenions les raisons, la réalité est que window.crypto assure plus d\'entropie que les mouvements de votre souris. L\'utilisation de ces mouvements est sûre mais nous (ainsi que de nombreux projets crypto) avons de bonnes raisons de croire en window.crypto. De plus, myebcwallet.com peut être utilisé sur des périphériques tactiles. Voici une [conversation entre un redditor rageur et Vitalik Buterin sur les mouvements de souris et window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) et voici [les spécifications w3 de window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Sécurité - MyEbcWallet CX ',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser myebcwallet.com au lieu de cette extension Chrome. ',
...
HELP_Sec_Desc_2             : 'Nous avons commencé en août 2015. Si vous recherchez ["MyEbcWallet" sur reddit](https://www.reddit.com/search?q=MyEbcWallet), vous pouvez voir qu\'un nombre considérable de personnes nous utilisent sans problème. ',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github et vous pouvez en voir le code source ici : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) aux [https://www.myebcwallet.com](https://www.myebcwallet.com). ',

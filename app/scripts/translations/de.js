...
tx_notFound_4               : 'Bitte benutzen Sie das DropDown Menü oben-rechts & wählen Sie eine andere Node aus (z.B. `ETH (scan.ebccoin.io)` oder `ETH (Infura.io)` oder `ETH (MyEbcWallet)`) und prüfen es erneut.',
...
GEN_Help_12                 : 'Nutze es um dein Wallet bei MyEbcWallet (oder Mist, Geth, Parity und andere Wallet Clients.) zu öffnen ',
...
HELP_Desc                   : 'Hast du das Gefühl etwas fehlt? Hast du eine andere Frage? [Schreib uns](mailto:support@myebcwallet.com) und wir werden nicht nur deine Frage beantworten, wir werden auch die Seite updaten, damit diese in der Zukunft noch einfacher zu bedienen sein wird! ',
HELP_Remind_Title           : 'Ein paar Erinnerungshilfen ',
HELP_Remind_Desc_1          : '**Ethereum, myebcwallet.com & MyEbcWallet CX, sowie einige der verwendeten Javascript Bibliotheken, die wir verwenden, befinden sich noch in Entwicklung.** Zwar haben wir alles umfassend getestet und es wurden erfolgeich tausende Wallets von Menschen aus aller Welt kreiert, jedoch bestimmt immer eine gewisse Gefahr, dass etwas unerwartetes passiert und dein Ether verloren geht. Bitte investiere nicht mehr als du verlieren kannst, und sei immer vorsichtig. Sollte etwas schlimmes passieren, **können wir uns leider nicht verantwortlich für einen Verlust zeichnen**. ',
HELP_Remind_Desc_2          : 'myebcwallet.com & MyEbcWallet CX sind keine "web wallets". Du erstellst keinen Account oder sendest uns Ether den wir halten. Alle Daten bleiben auf deinem Computer, bzw. Browser. Unser Auftrag ist es, dir das Erstellen, Speichern und Zugreifen auf deine Accounts zu vereinfachen, sowie dir eine simple Möglichkeit zur Interaktion mit der Blockchain zu bieten. ',
...
HELP_0_Desc_1               : 'MyEbcWallet bietet dir die Möglichkeit neue Wallets zu generieren, damit du deinen Ether selbst speichern kannst, und keine Exchange nutzen musst. Dieser Prozess findet ausschließlich auf deinem Computer statt. Daher bist auch **du dafür Verantwortlich, Back-ups zu erstellen** wenn du ein Wallet verwenden möchtest. ',
...
HELP_4CX_Title              : '4) Wie kann ich Ether über MyEbcWallet CX senden? ',
...
HELP_5_Title                : '5) Wie kann ich myebcwallet.com offline/lokal starten? ',

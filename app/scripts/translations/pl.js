...
MYWAL_Content_3             : 'Jeśli będziesz chciał w przyszłości używać ten portfel ze swoim MyEbcWallet CX, będziesz musiał go ponownie dodać używając klucza prywatnego/pliku JSON i hasła. ',
...
ADD_Ledger_0a               : 'Otwórz MyEbcWallet ponownie na bezpiecznym połączeniu (SSL) ',
ADD_Ledger_0b               : 'Otwórz MyEbcWallet w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
ERROR_28                    : '**Potrzebujesz plik Keystore i hasło, lub Klucz Prywatny** aby uzyskać dostęp do tego portfela w przyszłości. Wykonaj zewnętrzną kopię bezpieczeństwa! Nie ma możliwości odzyskania portfela jeżeli go nie zapiszesz. Wejdź na [stronę pomocy](https://www.myebcwallet.com/#help) po instrukcje. ',
...
HELP_0_Desc_1               : 'MyEbcWallet daje Ci możliwość generowania nowych portfeli abyś mógł przechowywać własne środki samodzielnie, nie na portalu wymiany walut. Ten proces odbywa się w całości na Twoim komputerze, nie na naszych serwerach. Z tego powodu, gdy generujesz nowy portfel, **to Ty jesteś odpowiedzialny za jego bezpieczne przechowywanie**. ',
...
HELP_2b_Title               : '2b) Jak mogę utworzyć portfel w 100% odizolowany od sieci globalnej (Cold Wallet) wykorzystując MyEbcWallet? ',
...
HELP_4CX_Title              : '4)Jak wysłać Ether używając MyEbcWallet CX? ',
...
HELP_5_Title                : '5) Jak uruchomić MyEbcWallet offline/lokalnie? ',
HELP_5_Desc_1               : 'Możesz uruchomić MyEbcWallet lokalnie ze swojego komputera zamiast z serwerów GitHub\'a. Możesz wygenerować portfel całkowicie offline\'owo i wysyłać transakcje z zakładki "Wyślij offline". ',
HELP_5_Desc_7               : 'MyEbcWallet działa teraz w całości na Twoim komputerze. ',
HELP_5_Desc_8               : 'W razie gdybyś nie wiedział, musisz zachować cały folder, aby strona działała prawidłowo, nie tylko `index.html`. Nie ruszaj i nie przenoś nic innego w folderze. Jeżeli zachowujesz kopie repozytorium MyEbcWallet na przyszłość, zalecamy przechowywać je w formie spakowanego pliku ZIP, aby mieć pewność, że jego zawartość się nie zmieniła. ',
HELP_5_Desc_9               : 'Ponieważ ciągle aktualizujemy MyEbcWallet, zalecamy co jakiś czas aktualizować  zapisaną wersję repozytorium. ',
...
HELP_8_Desc_1               : 'MyEbcWallet nie jest usługą portfela internetowego. Nie posiadasz loginu i nic nie jest zapisywane na naszych serwerach. To tylko interfejs, który pozwala korzystać z sieci Ethereum. ',
HELP_8_Desc_2               : 'Jeżeli myebcwallet.com zostanie wyłączona, musiałbyś znaleźć inny sposób (jak Ethereum Wallet / Mist) na korzystanie z sieci Ethereum. Nie musiałbyś jednak wypłacić swoich środków z MyEbcWallet, ponieważ one nie znajdują się na MyEbcWallet, a na portfelach, które zostały wygenerowane za pomocą naszej strony. ',
...
HELP_8CX_Desc_2             : 'Z tego powodu, jest **niezmiernie ważnym** aby wykonywać kopie bezpieczeństwa wszystkich nowych portfeli wygenerowanych za pomocą MyEbcWallet CX. W ten sposób, jeżeli cokolwiek stanie się MyEbcWallet CX lub Twojemu komputerowi, wciąż będziesz miał wszelkie niezbędne informacje potrzebne aby odzyskać dostęp do Twoich portfeli. Zobacz punkt 2a aby dowiedzieć się jak wykonać kopie bezpieczeństwa. ',
HELP_8CX_Desc_3             : 'Jeżeli z jakiegoś powodu MyEbcWallet CX zniknie z Chrome Store, możesz wciąż znaleźć kod źródłowy na Github\'ie i załadować manualnie do Chrome. Zobacz pkt. 5 powyżej. ',
...
HELP_12_Title               : '12) Jak zaimportować portfel utworzony w MyEbcWallet do geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Używając pliku Keystore Geth/Mist z MyEbcWallet v2+.... ',
...
HELP_16_Desc_1              : 'Możesz użyć eksploratora bloków jak [scan.ebccoin.io](http://scan.ebccoin.io/). Wklej swój adres w wyszukiwarkę na stronie eksploratora, pokaże ona stan Twojego konta oraz historię transakcji. Tak na przykład wygląda nasze [konto donacji](http://scan.ebccoin.io/account/0x7cb57b5a97eabe94205c07890be4c1ad31e486a8) na scan.ebccoin.io. ',
...
HELP_SecCX_Title            : 'Bezpieczeństwo - MyEbcWallet CX ',
...
HELP_Sec_Desc_2             : 'Działamy od sierpnia 2015. Jeśli wyszukasz ["MyEbcWallet" na reddit](https://www.reddit.com/search?q=MyEbcWallet), możesz znaleźć wielu ludzi, którzy używają naszego kodu bez najmniejszych problemów. ',
...
HELP_Sec_Desc_4             : 'Sprawdź adres URL -- Ta strona jest serwowana przez GitHub. Kod źródłowy jest dostępny pod: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Strona jest dostępna pod domenami: [https://www.myebcwallet.com](https://www.myebcwallet.com). ',
